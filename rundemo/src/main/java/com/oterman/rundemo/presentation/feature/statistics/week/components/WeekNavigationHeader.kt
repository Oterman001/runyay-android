...
/**
 * Week navigation header with previous/next buttons and date range display
 * Double-tap on date to jump to current week
 */
@Composable
fun WeekNavigationHeader(
    ...
    Row(
        ...
        // Date range (double tap to go to current week)
        Text(
            text = dateRange,
            fontSize = 16.sp,
